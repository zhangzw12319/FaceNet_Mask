...
sys.path.append("/media/zhangzhizhong/wjm/code/insightface_baseline_torch/python-package")
import insightface
...
class Handler:
    def __init__(self, prefix, epoch, im_size=128, ctx_id=0):
        ...
        self.detector = insightface.model_zoo.get_model('antelope')
        print(self.detector)
    ...
    def detect(self, img, S=128):
        ...
        bboxes, _ = self.detector.detect(img_det, threshold=0.5, input_size=(width, height))
        bboxes /= det_scale
        return bboxes
